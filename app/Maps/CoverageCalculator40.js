...
$(function ()
{
    $('#container').highcharts({
        ...
        labels:
        {
            items:
            [{
                html: Crotchet + ' ms/Beat<br></br>Total Note Coverage ' + CoverageTrick[0] + '% (' + CoverageTrick[1] + '% for C&L Weight) ●SIF Version: 4.0<br></br>国服当前使用4.0的算法但是卡库是4.1的请自行检查卡组参数',
                style: 
                {
                    left: '-30px',
